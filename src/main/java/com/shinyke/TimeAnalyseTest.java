...
public class TimeAnalyseTest {
    ...
    public void testTimeNLP() throws URISyntaxException {
        ...
        normalizer.parse("两小时后");// 抽取时间
        TimeUnit[] unit2 = normalizer.getTimeUnit();
        System.out.println(DateUtil.formatDateDefault(unit2[0].getTime()) + "-" + unit2[0].getIsAllDayTime());
        System.out.println(DateUtil.formatDateDefault(unit2[0].getBoundaryTime()) + "-" + unit2[0].getIsAllDayTime());
